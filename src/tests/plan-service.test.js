...
test('Should enable free features for free plan', async () => {
    ...
    assert(service.isEnabled('locator.orXpath') === false, 'locator.orXpath should be disabled');
});
...
test('Should enable pro features for pro plan', async () => {
    ...
    assert(service.isEnabled('locator.orXpath') === true, 'locator.orXpath should be enabled in Pro');
